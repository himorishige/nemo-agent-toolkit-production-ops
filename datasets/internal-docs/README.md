...
- 登場する企業名「アサヒシステムズ株式会社」、社員氏名、顧客名、電話番号、メールアドレス、住所、ID 値などは、実在する企業・人物・連絡先と一致するものではありません
- 電話番号は `03-1XXX-XXXX` のような架空形式、メールは `@asahi-systems.example.com` ドメインで統一しています
